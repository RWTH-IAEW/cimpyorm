...
latex_documents = [
    (master_doc, 'cimpyorm.tex', 'cimpyorm Documentation',
     'Thomas Offergeld', 'manual'),
]
...
man_pages = [
    (master_doc, 'cimpyorm', 'cimpyorm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cimpyorm', 'cimpyorm Documentation',
     author, 'cimpyorm', 'One line description of project.',
     'Miscellaneous'),
]
